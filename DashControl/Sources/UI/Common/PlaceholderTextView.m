...
- (void)setPlaceholderText:(nullable NSString *)placeholderText {
    ...
    if (self.isFirstResponder) {
        ...
        attributes = @{
            NSFontAttributeName : self.font ?: [UIFont dc_montserratLightFontOfSize:14.0],
            NSForegroundColorAttributeName : [UIColor colorWithRed:144.0 / 255.0 green:148.0 / 255.0 blue:156.0 / 255.0 alpha:1.0],
        };
    }
