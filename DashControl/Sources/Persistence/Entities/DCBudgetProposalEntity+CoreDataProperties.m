...
#import "DCBudgetProposalEntity+CoreDataProperties.h"

@implementation DCBudgetProposalEntity (CoreDataProperties)

+ (NSFetchRequest<DCBudgetProposalEntity *> *)fetchRequest {
	return [[NSFetchRequest alloc] initWithEntityName:@"DCBudgetProposalEntity"];
}

@dynamic abstainVotesCount;
